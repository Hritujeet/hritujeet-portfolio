...
const AboutPage = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <div
                ref={heroRef}
                className={`relative overflow-hidden w-[80vw] h-[70vh] flex flex-col justify-center items-center mx-auto my-20 shadow-lg shadow-blue-600/20 bg-blue-600/10 rounded-lg transform transition-all duration-1000 ${
