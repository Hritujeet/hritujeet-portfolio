...
const BlogItem = (props: Props) => {
  ...
  return (
    <div className='group relative border border-gray-800/50 p-0 rounded-2xl bg-gray-900 duration-300 cursor-default overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-blue-500/10'>
        ...
        <div className="relative z-10 p-4 space-y-6">
            <div className="header relative overflow-hidden rounded-xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 duration-300 rounded-xl"></div>
            </div>
            
            <div className="body space-y-4">
                <h2 className="text-2xl text-blue-400 leading-tight duration-300">
                    {title}
                </h2>
                <p className='font-inter text-sm text-gray-300 leading-relaxed group-hover:text-gray-200 duration-300'>
                    {description}
                </p>
            ...
            <div className="footer flex items-center justify-between">
                <Link 
                    href={`/blogs/${slug}`}
                    className="group/btn relative font-medium text-sm px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white rounded-lg cursor-pointer duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25 border border-blue-500/20"
                >
                ...
                <div className="flex items-center gap-2">
                    <button className="p-2 text-gray-400 hover:text-blue-400 hover:bg-gray-800/50 rounded-lg duration-200">
