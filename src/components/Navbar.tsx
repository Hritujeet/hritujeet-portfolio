...
const Navbar = () => {
    ...
    return (
        <header
            className="flex drop-shadow-xl shadow-blue-400/40 backdrop-blur-lg justify-between items-center px-10 py-2 h-16 bg-transparent md:sticky md:top-0 text-gray-300 relative font-semibold z-20"
            role="navigation"
        >
